...
namespace MongoRepository
{
    ...
    public interface IRepositoryManager<TEntity, TKey>
        where TEntity : IEntity<TKey>
    {
        ...
        Task<bool> IndexExists(string keyname);
        ...
        /// <param name="keynames">The indexed fields.</param>
        /// <returns>Returns true when the indexes exist, false otherwise.</returns>
        Task<bool> IndexesExists(IEnumerable<string> keynames);
